...
import 'package:tungstn/client/alert.dart';
...
import 'package:tungstn/client/error_profile.dart';
import 'package:tungstn/client/matrix/auth/matrix_sso_login_flow.dart';
import 'package:tungstn/client/matrix/auth/matrix_username_password_login_flow.dart';
...
import 'package:tungstn/client/matrix/database/matrix_database.dart';
import 'package:tungstn/client/matrix/extensions/matrix_client_extensions.dart';
import 'package:tungstn/client/matrix/matrix_native_implementations.dart';
import 'package:tungstn/client/matrix/matrix_room_preview.dart';
import 'package:tungstn/client/room_preview.dart';
...
import 'package:tungstn/utils/list_extension.dart';
import 'package:tungstn/utils/notifying_list.dart';
import 'package:tungstn/utils/stored_stream_controller.dart';
...
class MatrixClient extends Client {
  ...
  static String newLoginClientName() {
    ...
    if (existing == null || existing.isEmpty) {
      return 'tungstn-${BuildConfig.PLATFORM}';
    }
    return 'tungstn-${DateTime.now().millisecondsSinceEpoch}';
  }
  ...
  Future<Room> createRoom(CreateRoomArgs args) async {
    ...
    if (args.roomType == RoomType.photoAlbum) {
      creationContent = {"type": "chat.tungstn.photo_album"};
    }
    ...
    if (args.roomType == RoomType.calendar) {
      const widgetId = "chat.tungstn.room_calendar";
      var widgetHost = GlobalConfig.calendarWidgetHost;
      creationContent = {"type": "chat.tungstn.calendar"};
      initialState = [
        matrix.StateEvent(
          content: {
            "type": "chat.tungstn.widgets.calendar",
            "url":
