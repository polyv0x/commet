import 'package:tungstn/client/client.dart' as tungstn;
...
extension MatrixExtensions on Client {
  ...
  Future<RoomPreview?> getRoomPreview(String roomId,
    ...
    var type = switch (result["room_type"]) {
      "m.space" => tungstn.RoomType.space,
      "chat.tungstn.calendar" => tungstn.RoomType.calendar,
      "chat.tungstn.photo_album" => tungstn.RoomType.photoAlbum,
      "org.matrix.msc3417.call" => tungstn.RoomType.voipRoom,
      _ => tungstn.RoomType.defaultRoom
    };

    var visibility = switch (joinRule) {
      "public" => tungstn.RoomVisibilityPublic(),
      "knock" => tungstn.RoomVisibilityPrivate(),
      "invite" => tungstn.RoomVisibilityPrivate(),
      "private" => tungstn.RoomVisibilityPrivate(),
      "restricted" => tungstn.RoomVisibilityRestricted([]),
      _ => tungstn.RoomVisibilityPrivate(),
    };
