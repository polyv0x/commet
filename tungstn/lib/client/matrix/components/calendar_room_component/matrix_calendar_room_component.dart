...
import 'package:tungstn/client/components/calendar_room/calendar_sync.dart';
...
import 'package:tungstn/client/matrix/widget/privelidged_matrix_widget_runner.dart';
...
import 'package:tungstn/utils/timezone_utils.dart';
...
class MatrixCalendarRoomComponent
  ...
  static const String syncedCalendarsEventType =
      "chat.tungstn.calendar.synced_calendar_urls";
  ...
  bool get hasCalendarWidget =>
      room.matrixRoom.states.containsKey("chat.tungstn.calendar_events") ||
      room.matrixRoom.states["im.vector.modular.widgets"]?.values.any((i) =>
              i.content["type"] == "chat.tungstn.widgets.calendar" ||
