import 'package:tungstn/client/components/emoticon/emoji_pack.dart';
import 'package:tungstn/client/components/emoticon/emoticon.dart';
import 'package:tungstn/client/components/emoticon/emoticon_component.dart';
import 'package:tungstn/client/matrix/components/emoticon/matrix_emoticon.dart';
...
import 'package:tungstn/client/matrix/matrix_mxc_file_provider.dart';
  ...
  Future<TimelineEvent?> sendSticker(
    ...
    var content = {
      ...
      if (preferences.stickerCompatibilityMode.value)
        "chat.tungstn.type": "chat.tungstn.sticker",
      "info": {
        "w": image.width,
        "h": image.height,
