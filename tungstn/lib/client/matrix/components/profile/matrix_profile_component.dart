...
class MatrixProfile
  ...
  static Future<ProfileBadge?> badgeFromContent(MatrixClient client,
    ...
    var brightnessStr = awardContent["chat.tungstn.image_brightness"];
...
class MatrixProfileComponent implements UserProfileComponent<MatrixClient> {
  static const String bannerKey = "chat.tungstn.profile_banner";
  static const String colorSchemeKey = "chat.tungstn.profile_color_scheme";
  static const String bioKey = "chat.tungstn.profile_bio";
  static const String badgeKey = "chat.tungstn.profile_badges";
  static const String statusKey = "chat.tungstn.profile_status";
  ...
  Future<List<ProfileBadge>> getAvailableBadges() async {
    var accountEntries = client.matrixClient.accountData.entries
        .where((i) => i.key.startsWith("chat.tungstn.profile_badge."));
  ...
  Future<void> setProfileBadges(List<ProfileBadge> badges) {
    return setField(
        "chat.tungstn.profile_badges", badges.map((i) => i.source).toList());
  }
}
