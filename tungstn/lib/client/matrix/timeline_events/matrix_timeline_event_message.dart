...
import 'package:tungstn/main.dart' show preferences;
import 'package:http/http.dart' as http;
import 'package:tungstn/client/matrix/components/threads/matrix_thread_timeline.dart';
...
import 'package:tungstn/client/matrix/timeline_events/matrix_timeline_event_mixin_reactions.dart';
import 'package:tungstn/client/matrix/timeline_events/matrix_timeline_event_mixin_related.dart';
...
import 'package:tungstn/ui/atoms/rich_text/matrix_html_parser.dart';
import 'package:tungstn/utils/mime.dart';
import 'package:tungstn/utils/oembed.dart';
...
class MatrixTimelineEventMessage extends MatrixTimelineEvent
  ...
  String? get bodyFormat =>
      ...
      "chat.tungstn.custom.matrix_plain";
  ...
  List<Attachment>? _parseInlineImage() {
    ...
    final inlineImage =
        event.content['com.tungstn.inline_image'] as Map<String, dynamic>?;
    if (inlineImage != null) {
