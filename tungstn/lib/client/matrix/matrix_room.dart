...
import 'dart:ui';
import 'package:tungstn/client/components/component_registry.dart';
...
import 'package:tungstn/client/components/emoticon_recent/recent_emoticon_component.dart';
...
import 'package:tungstn/client/matrix/matrix_attachment.dart';
import 'package:tungstn/client/matrix/matrix_client.dart';
import 'package:tungstn/client/matrix/matrix_member.dart';
import 'package:tungstn/client/matrix/matrix_mxc_image_provider.dart';
import 'package:tungstn/client/matrix/matrix_peer.dart';
import 'package:tungstn/client/matrix/matrix_role.dart';
import 'package:tungstn/client/matrix/matrix_room_permissions.dart';
import 'package:tungstn/client/matrix/matrix_timeline.dart';
import 'package:tungstn/client/matrix/timeline_events/matrix_timeline_event_add_reaction.dart';
import 'package:tungstn/client/matrix/timeline_events/matrix_timeline_event.dart';
import 'package:tungstn/client/matrix/timeline_events/matrix_timeline_event_call.dart';
import 'package:tungstn/client/matrix/timeline_events/matrix_timeline_event_create_room.dart';
import 'package:tungstn/client/matrix/timeline_events/matrix_timeline_event_edit.dart';
import 'package:tungstn/client/matrix/timeline_events/matrix_timeline_event_edit_calendar.dart';
import 'package:tungstn/client/matrix/timeline_events/matrix_timeline_event_emote.dart';
import 'package:tungstn/client/matrix/timeline_events/matrix_timeline_event_encrypted.dart';
import 'package:tungstn/client/matrix/timeline_events/matrix_timeline_event_membership.dart';
import 'package:tungstn/client/matrix/timeline_events/matrix_timeline_event_message.dart';
import 'package:tungstn/client/matrix/timeline_events/matrix_timeline_event_pinned_messages.dart';
import 'package:tungstn/client/matrix/timeline_events/matrix_timeline_event_redaction.dart';
import 'package:tungstn/client/matrix/timeline_events/matrix_timeline_event_sticker.dart';
import 'package:tungstn/client/matrix/timeline_events/matrix_timeline_event_unknown.dart';
import 'package:tungstn/client/member.dart';
import 'package:tungstn/client/permissions.dart';
import 'package:tungstn/client/role.dart';
...
import 'package:tungstn/utils/image_utils.dart';
import 'package:tungstn/utils/mime.dart';
  ...
  TimelineEvent convertEvent(matrix.Event event, {matrix.Timeline? timeline}) {
    ...
    try {
      ...
      if (event.type == matrix.EventTypes.Message) {
        ...
        if (event.content["chat.tungstn.type"] == "chat.tungstn.sticker" &&
