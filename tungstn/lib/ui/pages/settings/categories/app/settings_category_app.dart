import 'package:tungstn/client/components/voip/voip_component.dart';
import 'package:tungstn/config/build_config.dart';
import 'package:tungstn/config/experiments.dart';
import 'package:tungstn/config/platform_utils.dart';
import 'package:tungstn/main.dart';
import 'package:tungstn/ui/pages/settings/categories/app/advanced_settings_page.dart';
import 'package:tungstn/ui/pages/settings/categories/app/appearance_settings_page.dart';
import 'package:tungstn/ui/pages/settings/categories/app/experiments_settings_page.dart';
import 'package:tungstn/ui/pages/settings/categories/app/general_settings_page.dart';
import 'package:tungstn/ui/pages/settings/categories/app/shortcut_settings/shortcut_settings_page.dart';
import 'package:tungstn/ui/pages/settings/categories/app/voip_settings/voip_settings_page.dart';
import 'package:tungstn/ui/pages/settings/categories/app/notification_settings/notification_settings_page.dart';
import 'package:tungstn/ui/pages/settings/categories/app/window_settings.dart';
import 'package:tungstn/ui/pages/settings/categories/developer/developer_settings_page.dart';
import 'package:tungstn/ui/pages/settings/settings_category.dart';
