...
void fl_register_plugins(FlPluginRegistry* registry) {
  ...
  g_autoptr(FlPluginRegistrar) flutter_webrtc_noise_suppressor_registrar =
      fl_plugin_registry_get_registrar_for_plugin(registry, "FlutterWebrtcNoiseSuppressorPlugin");
  flutter_webrtc_noise_suppressor_plugin_register_with_registrar(flutter_webrtc_noise_suppressor_registrar);
